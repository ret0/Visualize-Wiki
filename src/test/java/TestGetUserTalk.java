...
public class TestGetUserTalk {
    ...
    public void getUserTalk() {
        ...
        List<String> sortMap = ms.sortMap(download, 10);
        List<String> expected = Lists.newArrayList("89\tSmartse\t-7047", "84\tCybercobra\t-7814",
                "79\tGregcaletta\t38543", "78\tVeritysense\t1742", "68\tSpitzl\t-1128",
                "57\tAndyTheGrump\t123093", "50\tFunandtrvl\t-1809", "47\tFelixhonecker\t-6955",
                "46\tF.F.McGurk\t-10030", "42\tOcaasi\t-10827");
